...
Read this first. It is your front door. (If you are the non-technical OWNER, your front door is
`START-HERE.md` instead — it starts a project in three steps with no jargon.)
